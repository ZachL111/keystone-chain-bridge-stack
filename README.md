...
keystone-chain-bridge-stack is a C project for blockchain tooling. It focuses on this technical goal: Implement a C blockchain tooling project for bridge policy evaluation, using deny and allow fixtures and explainable decision traces.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 150, risk penalty 4, latency penalty 3, and weight bonus 2. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
